...
/**
 * Cette fonction sert à Sélectionner aléatoirement n éléments d'un tableau
 */
...
async function main() {
  ...
  // Supprission des des DECK pour respecter les contraintes de clés étrangères
  ...
  console.log(
    `Created "Starter Deck" for ${redUser.username} with ${randomCardsForRed.length} cards`,
  )
  ...
  console.log(
    ` Created "Starter Deck" for ${blueUser.username} with ${randomCardsForBlue.length} cards`,
  )
